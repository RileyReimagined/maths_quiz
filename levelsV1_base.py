...
while True:
    ...
    if level == "easy" or level == "Easy":
        ...
        # question 3
        while True:
            question1 = int(input("Third Question, what is {} + {}? ".format(num3, num4)))
            print(question1)
        ...
        # question 6
        while True:
            question1 = int(input("Sixth Question, what is {} - {}? ".format(num7, num8)))
            print(question1)
        ...
        while True:
            question1 = float(input("Fifth Question, what is {} ÷ {}? ".format(num13, 2)))
            print(question1)
        ...
        while True:
            question1 = int(input("Seventh Question, what is {} + ( {} x {} )? ".format(num17, num18, num19)))
            print(question1)
